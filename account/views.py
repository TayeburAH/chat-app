    ...
    if request.method == "GET":
        ...
        if len(search_query) > 0:
            ...
            if user.is_authenticated:
                ...
                your_friend_list = FriendList.objects.get(user=user)
                for account in search_results:
                    accounts.append((account, your_friend_list.is_mutual_friend(account)))
                    # three options, friends, not friends and  you
...
def account_view(request, *args, **kwargs):
    ...
    if account:
        try:
            # check whether this user has FriendList object
            friend_list = FriendList.objects.get(user=account)
        except FriendList.DoesNotExist:
            friend_list = FriendList(user=account)
            friend_list.save()
        friends = friend_list.friends.all()
        context['friends'] = friends  # to count how many friends he has in template friends|length
        ...
        if user.is_authenticated and user != account:
            is_self = False
            # you are in someone's else account
            # Check are you his friend?
            ...
            try:
                ...
                # display all the friend request you got
            except:
                pass
